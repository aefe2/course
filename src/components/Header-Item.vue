    ...
    <div class="header">
      ...
      <div class="switch-container">
        <transition-group name="icon">
          <svg v-show="isSwitch" :key="1" width="27" height="27" viewBox="0 0 36 37" fill="none"
          ...
          <svg v-show="!isSwitch" :key="2" width="27" height="27" viewBox="0 0 36 37" fill="none"
               xmlns="http://www.w3.org/2000/svg">
        ...
        <div @click="themeModule" class="switch-btn" :class="{'switch-on': isSwitch}"></div>
      </div>
    </div>
  </div>
</template>
