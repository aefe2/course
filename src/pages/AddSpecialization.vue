<template>
  <div class="form-container">
    <form-item @submit.prevent="addSpecialization" class="heal-form">
      <my-label for="heal-name">Специальность</my-label>
...
export default {
  ...
  methods: {
    addSpecialization() {
      axios({
        method: 'post',
        url: 'http://localhost/CodingOnSideOfServer/api/add_specialization',
        headers: {
