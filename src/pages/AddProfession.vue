<template>
  <div class="form-container">
    <form-item @submit.prevent="addProfession" class="heal-form">
      <my-label for="heal-name">Профессия</my-label>
...
export default {
  ...
  methods: {
    addProfession() {
      axios({
        method: 'post',
        url: 'http://localhost/CodingOnSideOfServer/api/add_profession',
        headers: {
